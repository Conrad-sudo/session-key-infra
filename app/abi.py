...
Only ABIs with no upstream source belong here. The ERC-20 ABI was removed in favour of
langchain_erc20.ERC20_ABI (function-identical, and the one the toolkits actually encode
against); erc20_mock and mock_v3_aggregator were removed as dead — nothing imported them.
"""
